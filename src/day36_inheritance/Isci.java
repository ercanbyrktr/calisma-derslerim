...
public class Isci extends Personel{
    ...
    Personel class'indaki tum variable ve methodlara ihtiyaci
    ...
    2- parent class'daki ozelliklerden bazilarinin kendine uyarlayabilir
    3- parent class'da olmayan bazi yeni ozellikler olusturabilir
    not: parent class'daki ozelliklerden hicbirini reddedemez ama degisitrebilir
     */
    int persNo=1001;
