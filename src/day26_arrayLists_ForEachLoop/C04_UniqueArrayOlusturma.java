package day26_arrayLists_ForEachLoop;
...
public class C04_UniqueArrayOlusturma {
    public static void main(String[] args) {
        // 2) Verilen bir array'deki tekrar eden elementleri tek bir defa barindiran
    ...
    public static int[] uniqueArrayOlustur(int[] arr) {
        ...
        // yanindaki elemente eşit olmayanlari listeye ekliyor
        ...
        // benzersiz listedki tum elemanlari, yeni array e atadik
