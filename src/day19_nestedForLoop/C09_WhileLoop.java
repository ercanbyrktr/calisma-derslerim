...
public class C09_WhileLoop {
    public static void main(String[] args) {
        ...
        Asagidaki sartlari sagliyorsa "Sifre basari ile tanimlandi",
         sartlari saglamazsa "Islem basarisiz, Lutfen yebi bir sifre girin" yazdirin
         ve basarili sifre girinceye kadar tekrar sifre girmesini isteyin
        - Ilk harf buuyuk olmali
        ...
        while (!sifreBasariliMi) {
            ...
            sifre = scan.nextLine();
            // 4 kontrolu yapalim, her gecen kontrol icin kontrol variable'ini bir arttiralim
            //ilk harf kontrolu
