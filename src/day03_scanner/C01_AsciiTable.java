...
public class C01_AsciiTable {
    public static void main(String[] args) {
     ...
     1- char data turu isleme girdigi degiskenin turune gore farkli davranabilir
        eger toplandigi variable sayisal bir degerse sayi gibi davranir
        sayi+harf sayi variable'i int oldugundan harf variable'i asci tablosundan 97 degerini

        char yeniHarf = harf+2;  java once sagdaki islemi yapar, sagdaki int + char gorunce asccii degerini alir
