...
public class ArabaRunner {
    public static void main(String[] args) {
        ...
        Araba araba1=new Araba("Opel", "Astra", "2015", "78000");
        araba1.fiyat=10000;
        ...
        System.out.println("Araba1 bilgileri\nMarka: " + araba1.marka + "\nModel : " + araba1.model
                + "\nyil :" + araba1.yil + "\nFiyat" + araba1.fiyat);
        /*
        Eger bir objeyi olustururken bazi ozelliklerini argument olarak belirtip
        ...
        bizim yeni ve parametreli constructor(lar)'a ihityacimiz var.
         */
        Araba araba2=new Araba("BMW", "5.20", Integer.parseInt(String.valueOf(2011)),15000);
        System.out.println("Araba2 bilgileri\nMarka: " + araba2.marka + "\nModel : " + araba2.model
                + "\nyil :" + araba2.yil + "\nFiyat" + araba2.fiyat);

        Araba araba3=new Araba("Opel","Astra", Integer.parseInt(String.valueOf(2015)),78000);
        System.out.println("Araba3 bilgileri\nMarka: " + araba3.marka + "\nModel : " + araba3.model
                + "\nyil :" + araba3.yil + "\nFiyat" + araba3.fiyat);

        Araba araba4 =new Araba("Audi","A5", Integer.parseInt(String.valueOf(2020)),50000);
